            ...
            >
                <Container>
                    <Flex
                        ...
                        gap="32px"
                    >
                        <h1 className={cls.title}><span>Бесплатный</span> Игровой хостинг</h1>
                        <p className={cls.disc}>Идеальный вариант для знакомства с нашим сервисом!</p>
                        <Button
                            ico={database.src}
                            onClick={scrollToSection}
                        >
                            Перейти к бесплатным тарифам
                        </Button>
